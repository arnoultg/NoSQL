...
exports.saveRender = function (data, templateName) {
	...
	if (templateName !== false) {
		...
		/* ...and set new base */
		Array.prototype.forEach.call(dom.window.document.getElementsByTagName("base"), function (base) {
			base.setAttribute("href", newBase.replace(/\/$/, ""));
		});

		/* Save the render. */
		save(NA, dom.serialize(), data, (templateName) ? templateName : "");
	}
};